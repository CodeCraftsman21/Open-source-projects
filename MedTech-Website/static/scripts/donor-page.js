...
let donors = JSON.parse(localStorage.donors);
let lastDonor = Array.from(donors).reverse()[0];
let ref=document.getElementById("donorID");
console.log(lastDonor);
ref.value=String(parseInt(lastDonor.donorID)+1);


function isDonor(num) {
